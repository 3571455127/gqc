...
<?php  $_result=M("slide_data")->field("*")->where("fid = 1 AND status=1 ")->order("id desc")->limit("5")->select();; if ($_result): $n=0;foreach($_result as $key=>$r):++$n;$mod = ($n % 2 );?><div class="swiper-slide"><a href="<?php echo ($r["link"]); ?>" title="<?php echo ($r["title"]); ?>"  target="_blank"><img src="<?php echo ($r["pic"]); ?>"
                    ...
                    <div class="container">
                        <div class="row">
                            <form class="banner-contant clearfix" method="post" action="index.php?g=Home&a=message" onsubmit="return beforeSubmit2(this);">
                                <h6>Contact Us</h6>
...
<!--                        <div class="swiper-slide">
    ...
    <div class="index">
        ...
        <div class="attest">
            <div class="container">
                <div class="row">
                    <div class="box-img col-lg-6 col-md-6 col-sm-6 col-xs-6"><img src="/Public/www/images/ISO9001.png" alt=""></div>
                    <div class="box-img col-lg-6 col-md-6 col-sm-6 col-xs-6"><img src="/Public/www/images/IATF16949.png" alt=""></div>
                </div>
            </div>
        </div>
        ...
        <div id="product">
            <div class="product">
                ...
                <div class="container">
                    <div class="row">
<?php  $_result=M("Product")->field("thumb,title,cont,listorder,id")->where(" 1  AND status=1  AND catid=94")->order("listorder desc")->limit("12")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><div class="pro-box clearfix">
                                ...
                                <div class="pro-btn clearfix">
                                    ...
                                    <div id="lightgallery">
                                        <div data-src="<?php echo ($r["document"]); ?>">
                                            <img class="img-responsive" src="/Public/www/images/download-b.png" alt="Thumb-1">
                                        </div>
                                    </div>
                            ...
                            <?php  $_result=M("Product")->field("thumb,title,cont,listorder,id")->where(" 1  AND status=1  AND catid=95")->order("listorder desc")->limit("12")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><div class="pro-box clearfix">
                                ...
                                <?php echo ($r["cont"]); ?>
                                    <div class="pro-btn clearfix">
                                        ...
                                        <div id="lightgallery">
                                        <div data-src="<?php echo ($r["document"]); ?>">
                                                <img class="img-responsive" src="/Public/www/images/download-w.png" alt="Thumb-1">
                                            </div>
                                        </div>
